      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            window.THREE = three_module; // console.log(library)
          ...
          case 14:
            ...
            result = runner(external_commonjs_vue_commonjs2_vue_root_Vue_default.a, three_module, window); // console.log(result)
...
/* harmony default export */ var SandBoxvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    var rAF = function rAF() {
      ...
      for (var key in _this.execStack) {
        var fn = _this.execStack[key];
